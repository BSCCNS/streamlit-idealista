...
### Features:
- **Interactive Map**: 
  - Draw and define areas of interest directly on the map.
  - Visualize geographic data related to properties.

- **Time Series Analysis**: 
  - Plot the evolution of rental prices and sales over the years within the drawn area.
  - Analyze trends and patterns in the real estate market.

- **Intervention Insights**:
  - Identify and highlight any interventions (superblocks) within the selected drawing zone.
  - Understand the impact of urban planning on property values.
...
with right:
    # Second container for the Plotly chart
    st.subheader("Data Visualization")
    
    # Create and display the chart
    chart = fc.plot_timeseries(processed_df, interventions_gdf, my_censustracts)
    st.plotly_chart(chart, use_container_width=True)  # Ensures full-width usage

# Additional explanation or context can be added below the columns if needed
st.write("### Analysis Summary")
st.write("This app allows users to draw geometries on the map and visualize related time series data in the chart.")