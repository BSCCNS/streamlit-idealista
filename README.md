...
│                         streamlit_idealista and configuration for tools like black
│
...
│
└── streamlit_idealista   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes streamlit_idealista a Python module
    │
